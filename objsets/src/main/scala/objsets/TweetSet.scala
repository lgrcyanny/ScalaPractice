 ...
 * invariant which always holds: for every branch `b`, all elements (The body) in the left
 * subtree are lexicographically smaller than the tweet at `b`. The elements in the right subtree are
 * larger
 *
...
abstract class TweetSet {
   ...
   * and be implemented in the subclasses? should be defined in subclass
   */
   ...
   *
   * Question: Should we implment this method here, or should it remain abstract
   * and be implemented in the subclasses?(answer: in subclasses)
   */
   ...
   * Question: Should we implment this method here, or should it remain abstract
   * and be implemented in the subclasses?(subclass)
   */
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    if (!left.isEmpty && leftMost.retweets > elem.retweets) {
      if (!right.isEmpty && rightMost.retweets > leftMost.retweets) rightMost
      else leftMost
